<template>
  <!-- 
    🛠️ 必杀技：使用 :style 动态绑定背景 
    这样我们可以用 import 进来的图片变量，保证路径绝对正确！
  -->
...
// import bgImage from '@/assets/images/chat/chat-bg.jpg' // 如果是jpg用这行
...
.chat-page {
  ...
  /* 这里不需要写 background-image 了，因为在 template 里用 JS 绑定了 */
